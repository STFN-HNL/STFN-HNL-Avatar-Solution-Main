...
export const TelcoOnboarding: React.FC<TelcoOnboardingProps> = ({
  onComplete,
}) => {
      ...
      content: (
        <div className="space-y-6">
          <h2 className="text-2xl font-bold text-primary-dark mb-4">
            Welcome to your interactive telco demo session.
          </h2>

          <div className="bg-accent/20 p-4 rounded-lg border border-accent/30">
            <p className="text-primary-dark font-medium">
              In this interactive simulation, you will experience a virtual
              telco customer service interaction:
            </p>
            <p className="text-primary-dark mt-2 font-semibold">
              Customer Service – Support, Solutions, Satisfaction – for
              effective customer interactions
            </p>
          </div>

          <p className="text-primary-light">
            The virtual agent will respond naturally—sometimes helpful,
            sometimes uncertain, and occasionally challenged. Your task is to
            stay engaged, ask relevant questions, and experience the service
            quality.
          </p>
        </div>
      ),
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start space-x-3">
              <div className="w-2 h-2 bg-accent rounded-full mt-2 flex-shrink-0" />
              <p className="text-primary-dark">
                Ensure a stable internet connection – the avatar requires good
                connectivity
              </p>
            </div>
            ...
            <div className="flex items-start space-x-3">
              <div className="w-2 h-2 bg-accent rounded-full mt-2 flex-shrink-0" />
              <p className="text-primary-dark">
                This is AI, not a human – it's not perfect, but it's a powerful
                way to learn
              </p>
            </div>
          </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="bg-accent/20 p-4 rounded-lg border border-accent/30 space-y-2">
              <p className="text-primary-dark">
                <strong>You are the customer</strong> – your job is to interact
                with the service agent
              </p>
              <p className="text-primary-dark">
                <strong>The avatar is the service agent</strong> – they will
                assist you
              </p>
              <p className="text-primary-light text-sm">
                If the avatar gets confused, say:{" "}
                <em>"Stay in the role of your prompt."</em>
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start space-x-3">
                ...
                <p className="text-primary-dark">
                  Type 'START Session' to begin the interaction
                </p>
              </div>
              <div className="flex items-start space-x-3">
                <span className="bg-accent text-primary-dark text-xs font-bold px-2 py-1 rounded-full min-w-[20px] text-center">
                ...
                <p className="text-primary-dark">
                  Ask questions about telco services, billing, or technical
                  support
                </p>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <p className="text-primary-dark">
                  Say: <em>"End session and give feedback."</em>
                </p>
              </div>
              <div className="flex items-start space-x-3">
                <span className="bg-accent text-primary-dark text-xs font-bold px-2 py-1 rounded-full min-w-[20px] text-center">
                ...
                <p className="text-primary-dark">
                  Receive personalized feedback on your interaction
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-accent p-6 rounded-lg text-primary-dark text-center">
            <h3 className="text-xl font-bold mb-2">
              Ready to Begin Your Telco Demo?
            </h3>
            <p className="mb-4">
              Click the button below to start your interactive customer service
              session.
            </p>
          </div>
        </div>
